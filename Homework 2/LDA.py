...
#---------------------
inputFile = pd.read_csv("D:\Coding\Python\ML in class\Homework 2\SCLC_study_output_filtered_2.csv",header=0)
...
ax.set_xlabel(r'$W_1$')
ax.set_ylabel('')
ax.plot(Y[:20], np.zeros(20), linestyle='None', marker='o', markersize=7, color='blue', label='NSCLC')
ax.plot(Y[20:], np.zeros(20), linestyle='None', marker='o', markersize=7, color='red', label='SCLC')
...
ax.set_xlabel(r'$W_1$')
ax.set_ylabel('')
ax.plot(sklearn_LDA_projection[II_0], np.zeros(len(II_0)), linestyle='None', marker='o', markersize=7, color='blue', label='NSCLC')
ax.plot(sklearn_LDA_projection[II_1], np.zeros(len(II_1)), linestyle='None', marker='o', markersize=7, color='red', label='SCLC')
ax.legend()
